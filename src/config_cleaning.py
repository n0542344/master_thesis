#config file for cleaning, transforming data.
# moved content from config.py to here

RAW_DATA_PATH = "./data/01_raw/blood-data_complete_2025-07-16.tsv"
CLEANED_DATA_PATH = "./data/02_cleaned/output_cleaned.csv"
TRANSFORMED_DATA_PATH = "./data/03_transformed/output_transformed.csv"
